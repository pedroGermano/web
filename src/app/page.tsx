  ...
  return (
    <div className="min-h-dvh flex flex-col justify-center gap-16">
      <div className="flex flex-col gap-8 items-center md:items-start">
        ...
        <h1
          className="text-4xl text-center leading-none font-heading 
            font-medium flex flex-col md:text-7xl md:text-left"
        >
        ...
        <form className="bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6 w-full md:max-w-[440px]">
          ...
          <div className="space-y-3">
            <InputRoot>
              ...
              <InputField type="text" placeholder="Nome completo"></InputField>
            </InputRoot>
